...
const AP_Param::Info Copter::var_info[] = {
    ...
    GSCALAR(gcs_pid_mask,           "GCS_PID_MASK",     0),
        ...
        // @Param: DIVE_TGT_ALT
    // @DisplayName: Dive Target Altitude
    // @Description: Altitude copter climbs to when Dive mode is activated (meters, relative to home)
    // @Units: m
    // @Range: 5 100
    // @User: Advanced
    // GSCALAR(dive_target_alt, "DIVE_TGT_ALT", 15),
